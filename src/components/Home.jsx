...
export default function Home() {
  return (
    <div className="container p-3">
      ...
      <div className="row d-flex w-100 bg-secondary w-100">
        <button className="btn"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-skip-start" viewBox="0 0 16 16">
